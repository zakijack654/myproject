...
function checkConn() {
  ...
  if (type == "wifi") {
    ...
    document.getElementById("conn-ef-type").innerHTML =
      "Connection effective type : " + eftype + "";
    document.getElementById("conn-down").innerHTML =
      "Connection download speed : " + downMax + "";
  }

  function updateConnectionStatus() {
    console.log(
      "Connection type change from " + type + " to " + connection.type
    );
...
function checkConnW() {
  ...
  if (type == "wifi") {
    document.getElementById("conn-type-2").innerHTML =
      "Connection type : " + type + "";
...
async function nfcAccess() {
  ...
  ndef.onreading = async (event) => {
    ...
    for (const record of event.message.records) {
      document.getElementById("nfc-record-type").innerHTML =
        "Record type : " + record.recordType + "";
      document.getElementById("nfc-media-type").innerHTML =
        "Media type : " + record.mediaType + "";
      document.getElementById("nfc-data").innerHTML =
        "NFC Data : " + decoder.decode(record.data) + "";
...
function magnetometer() {
  ...
  magSensor.addEventListener("reading", (e) => {
    ...
    document.getElementById("mag-x").innerHTML =
      "Mag X-axis " + magSensor.x + "";
    document.getElementById("mag-y").innerHTML =
      "Mag Y-axis " + magSensor.y + "";
    document.getElementById("mag-z").innerHTML =
      "Mag Z-axis " + magSensor.z + "";
  });
  magSensor.start();
}
...
function gyroscope() {
  ...
  gyroscope.addEventListener("reading", (e) => {
    ...
    document.getElementById("gyro-x").innerHTML =
      "Gyro X-axis " + gyroscope.x + "";
    document.getElementById("gyro-y").innerHTML =
      "Gyro Y-axis " + gyroscope.y + "";
    document.getElementById("gyro-z").innerHTML =
      "Gyro Z-axis " + gyroscope.z + "";
  });
  gyroscope.start();
}
...
if (type == "none") {
  ...
  document.getElementById("feature").innerHTML =
    "but some features still can be used";
}
